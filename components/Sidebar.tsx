...
import { 
  ...
  Calendar, Settings, Users2, LogOut 
} from "lucide-react";
  ...
  return (
    <div className="w-72 h-screen border-r border-white/10 p-6 flex flex-col glass-card rounded-none border-y-0 border-l-0">
      ...
      <div className="mb-12">
        ...
        <p className="text-[10px] text-gold tracking-[0.3em] uppercase font-bold italic">
          Intelligence Engine
        </p>
      </div>
      ...
      {/* FOOTER : RETOUR À LA DÉCONNEXION SIMPLE */}
      <div className="mt-auto pt-6 border-t border-white/10">
        <div className="flex items-center space-x-4 p-3 rounded-xl cursor-pointer text-gray-400 hover:text-rose-500 transition-all">
          <LogOut size={20} />
          <span className="font-semibold text-sm uppercase tracking-widest text-[10px]">Déconnexion</span>
        </div>
      </div>
