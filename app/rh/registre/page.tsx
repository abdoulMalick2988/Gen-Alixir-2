          ...
          <div className="h-full overflow-y-auto custom-scroll">
            <div className="p-5 md:p-7 space-y-6">
              ...
              <div className="flex flex-col lg:flex-row gap-3">
                ...
                <select className="cyber-select min-w-[200px]" value={activeDept} onChange={(e) => setActiveDept(e.target.value)}>
                  <option value="Tous">📁 Tous les départements</option>
                  {stats.depts.map((d: string) => (
                    <option key={d} value={d}>📂 {d}</option>
                  ))}
                </select>
                <select className="cyber-select min-w-[160px]" value={activeStatus} onChange={(e) => setActiveStatus(e.target.value)}>
