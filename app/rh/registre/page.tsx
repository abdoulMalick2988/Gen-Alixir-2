...
{/* ============================================================
   PARTIE 2 sur 3 — Coller directement après la fin de la Partie 1
   (après le </tbody></table></div>)
   ============================================================ */}
...
{/* ============================================================
   PARTIE 3 sur 3 — Coller directement après la fin de la Partie 2
   Ceci ferme le composant et ajoute les styles globaux
   ============================================================ */}
      ...
      <style jsx global>{`
        ...
        /* Sidebar réduite — override */
        nav, aside, [data-sidebar] {
          max-width: 60px !important;
          min-width: 60px !important;
          overflow: hidden;
        }
        nav span, aside span, [data-sidebar] span,
        nav p, aside p, [data-sidebar] p {
          display: none !important;
        }
        nav a, aside a, [data-sidebar] a {
