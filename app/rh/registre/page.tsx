...
export default function RegistrePersonnel() {
  ...
  const [payrollFilter, setPayrollFilter] = useState<string>("Tous"); // Nouveau filtre pour livre de paie
        ...
        <div className="holo-container w-full max-w-[1700px] mx-auto">
          ...
          <div className="max-h-[calc(100vh-3rem)] overflow-y-auto custom-scroll">
            <div className="p-4 md:p-7 space-y-6 pb-20">
              ...
              {/* ── BARRE DE RECHERCHE FUTURISTE (ICÔNE CORRIGÉE) ── */}
              ...
              {/* ── TABLEAU HOLOGRAPHIQUE (COLONNES ALIGNÉES) ── */}
...
/* ═══ PARTIE 3 FINALE — Coller après Partie 2 ═══ */
      ...
      {/* ═══ MODAL CONFIRMATION PAIEMENT (RÉPONSE RAPIDE) ═══ */}
      {payConfirm && (
      ...
      <style jsx>{`
        ...
        /* Badges cliquables dans la fiche */
...
/* ═══ FIN PARTIE 3 — CODE COMPLET ET OPTIMISÉ ═══ */
