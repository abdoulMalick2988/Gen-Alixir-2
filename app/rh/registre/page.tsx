...
import {
  ...
  Zap, Activity, Shield, Filter, SlidersHorizontal
} from "lucide-react";
...
export default function RegistrePersonnel() {
  ...
  const handlePhotoUpload = useCallback(async (empId: string, file: File) => {
    ...
    try {
      ...
      console.error(err);
      if (typeof window !== "undefined") window.alert("Erreur lors de l'upload de la photo.");
    } finally {
  ...
  const updateStatus = useCallback(async (id: string, ns: EmployeeStatus) => {
    ...
    const { error: e1 } = await supabase.from("staff").update({ status: ns }).eq("id_key", rid);
    if (e1) await supabase.from("staff").update({ status: ns }).eq("id", rid);
  }, []);
  ...
  const handleExport = useCallback(() => {
    ...
    const r = filteredData.map((e) => [
      ...
      String(e.salary), String(e.prime), e.status, e.paymentStatus, e.email, e.joinDate
    ]);
  ...
  // Écran de chargement ultra-futuriste
  if (loading) {
    return (
  ...
  /* ═══════════════════════════════════════════════════════════════
     INTERFACE PRINCIPALE - PARTIE 2/3
     ═══════════════════════════════════════════════════════════════ */
  ...
  <div className="max-h-[calc(100vh-3rem)] overflow-y-auto custom-scroll">
            <div className="p-5 md:p-7 space-y-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="ml-2">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <h1 className="text-xl md:text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-emerald-400 to-cyan-400 tracking-tight">
              ...
              <div className="flex flex-col lg:flex-row gap-3">
                <div className="relative flex-1">
                  ...
                  <div className="relative flex items-center">
                    <Search className="absolute left-4 text-cyan-500/60" size={16} />
                    <input
                      type="text"
                      placeholder="Rechercher un collaborateur (nom, ID, poste, email)..."
                    ...
                    {search && (
                      <button
                        onClick={() => setSearch("")}
                        type="button"
                        className="absolute right-4 text-cyan-500/60 hover:text-cyan-400 transition-colors"
                      >
                        <X size={16} />
                      </button>
                    )}
                ...
                <button
                  ...
                  type="button"
                  className={showFilters ? "cyber-btn-active min-w-[120px]" : "cyber-btn-alt min-w-[120px]"}
                >
                ...
                <button 
                  ...
                  type="button" 
                  className="cyber-btn-alt min-w-[130px]"
              ...
              {/* ── PANNEAU DE FILTRES ── */}
              {showFilters && (
                <div className="filter-panel-holo animate-slideDown">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-sm font-bold text-white">Filtres Avancés</h3>
                  </div>
                  ...
                  {(activeDept !== "Tous" || activeStatus !== "Tous") && (
                    <div className="mt-3 flex items-center justify-between">
                      ...
                      <button
                        ...
                        type="button"
                        className="text-[11px] text-amber-400 hover:text-amber-300 transition-colors font-semibold flex items-center gap-1"
                      >
                        <X size={12} />
                        Réinitialiser
                      </button>
                  ...
                  <table className="w-full text-left table-fixed">
                    ...
                    <thead>
                      <tr className="border-b border-cyan-500/20">
                        ...
                        <th className="table-header-holo">🏢 Département</th>
                        <th className="table-header-holo">💼 Poste</th>
                        <th className="table-header-holo">📄 Contrat</th>
                        <th className="table-header-holo">💰 Salaire</th>
                        <th className="table-header-holo">🎁 Prime</th>
                        <th className="table-header-holo">📊 Statut</th>
                        <th className="table-header-holo">💳 Paie</th>
                        <th className="table-header-holo text-right">⚙️ Actions</th>
                      </tr>
                    </thead>
                ...
                <div className="pagination-holo">
                  <div className="flex items-center gap-2">
                    ...
                    <p className="pagination-info-holo">
                      ...
                      {" "}enregistrement{filteredData.length > 1 ? "s" : ""}
                      {(search || activeDept !== "Tous" || activeStatus !== "Tous") && (
                        <span className="ml-2 px-2 py-0.5 bg-cyan-500/10 border border-cyan-500/20 rounded-md text-cyan-400">Filtré</span>
                      )}
      ...
      {payConfirm && (
        <div className="modal-overlay-holo animate-fadeIn">
          <div className="modal-container-holo animate-scaleIn">
            ...
            <div className="relative">
              ...
              <div className="flex gap-3">
                <button 
                  ...
                  type="button"
                  className="modal-btn-secondary-holo"
                >
                  <X size={15} />
                  <span>Annuler</span>
                </button>
      ...
      {selectedEmployee && (
        <div className="modal-overlay-holo animate-fadeIn">
          <div className="modal-container-xl-holo animate-scaleIn">
            ...
            <div className="relative max-h-[85vh] overflow-y-auto custom-scroll">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <button
                        ...
                        className={selectedEmployee.paymentStatus === "Payé" ? "payment-badge-paid-holo" : "payment-badge-pending-holo"}
                      >
                        ...
                        <span className="ml-1 text-[9px] opacity-60">(cliquer pour changer)</span>
                      </button>
              ...
              <div className="flex gap-3 pt-4 border-t border-cyan-500/20">
                <button 
                  onClick={() => setSelectedEmployee(null)} 
                  type="button"
                  className="modal-btn-secondary-holo flex-1"
                >
                  <ArrowLeft size={15} />
                  <span>Retour</span>
                </button>
      ...
      <style jsx>{`
        ...
        .cyber-btn-alt:hover:not(:disabled) {
