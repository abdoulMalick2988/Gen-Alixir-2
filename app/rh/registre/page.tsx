        ...
        <div className="flex-1 overflow-y-auto custom-scroll p-6 md:p-10">
          <div className="max-w-[1600px] mx-auto space-y-8 pb-12">
            ...
            <div className="flex flex-col lg:flex-row gap-3">
              <div className="relative flex-1">
                ...
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    className="cyber-input !pl-14 pr-11"
                    value={search}
              ...
              <button onClick={handleExport} type="button" className="cyber-btn-alt min-w-[130px]" disabled={isExporting}>
                {isExporting ? (
                      ...
                      <div className="relative p-4">
                        ...
                        <div className="space-y-2.5">
                          <div className="flex items-center justify-between text-[11px]">
                            <span className="text-cyan-500/60 flex items-center gap-1.5 truncate">
                              <Building2 size={10} />
                              {emp.dept}
                            </span>
