  ...
  return (
    <div className="min-h-screen relative overflow-y-auto" style={{
      ...
      <div className="max-w-6xl mx-auto p-3 md:p-6 relative z-10">
        ...
        {/* NOTIFICATIONS */}
        {notif && (
          <div className={`fixed top-4 left-1/2 -translate-x-1/2 z-50 px-6 py-3 rounded-xl border backdrop-blur-xl shadow-xl ${
          ...
          <div className="glass-card rounded-2xl p-4">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div className="flex items-center gap-4">
                <button 
                  onClick={() => router.back()} 
                  className="p-3 bg-gradient-to-br from-cyan-500/20 to-blue-500/20 rounded-xl border border-cyan-400/30 hover:border-cyan-400/50 transition-all hover:scale-105 group"
                >
              ...
              <button
                ...
                className="golden-card px-4 py-2 rounded-lg font-bold text-xs flex items-center gap-2 hover:scale-105 transition-all"
              >
          ...
          <div className="mb-6">
            <div className="bg-red-500/10 border border-red-400/40 rounded-2xl p-4">
              <div className="flex items-center gap-2 text-red-400 mb-3">
                <AlertCircle size={18} />
                <h3 className="text-sm font-black uppercase">Champs Requis</h3>
              </div>
          ...
          {[
            ...
            return (
              <div
                ...
                className={`section-card glass-card rounded-2xl p-4 cursor-pointer transition-all hover:scale-105 ${
              ...
              >
                ...
                <h3 className="text-lg font-black uppercase text-white mb-2">{label}</h3>
              ...
              {activeSection === 'company' && (
                <div className="glass-card rounded-2xl p-5 space-y-5">
                  <div className="flex items-center gap-3 pb-4 border-b border-cyan-400/20">
                    ...
                    <div>
                      <h2 className="text-xl font-black uppercase text-emerald-400">Entreprise</h2>
                      <p className="text-xs text-cyan-300/60">Informations légales</p>
                    </div>
                  </div>
                        ...
                        {data.compLogo ? (
                          <div className="relative group">
                            ...
                            <button
                              ...
                              className="absolute -top-1 -right-1 p-2 bg-red-500 text-white rounded-lg opacity-0 group-hover:opacity-100 transition-all"
                            >
                              <X size={12} />
                            </button>
                          </div>
                        ) : (
                          <label className="flex flex-col items-center justify-center h-32 border-2 border-dashed border-yellow-400/30 rounded-xl cursor-pointer hover:border-yellow-400/50 transition-all">
              ...
              {activeSection === 'employee' && (
                <div className="glass-card rounded-2xl p-5 space-y-5">
                  <div className="flex items-center gap-3 pb-4 border-b border-cyan-400/20">
                    ...
                    <div>
                      <h2 className="text-xl font-black uppercase text-blue-400">Salarié</h2>
                      <p className="text-xs text-cyan-300/60">Données personnelles</p>
                    </div>
                  </div>
              ...
              {activeSection === 'contract' && (
                <div className="glass-card rounded-2xl p-5 space-y-5">
                  <div className="flex items-center gap-3 pb-4 border-b border-cyan-400/20">
                    ...
                    <div>
                      <h2 className="text-xl font-black uppercase text-amber-400">Contrat</h2>
                      <p className="text-xs text-cyan-300/60">Conditions de travail</p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex flex-col gap-2">
                      ...
                      <select
                        ...
                        className="bg-black/60 border border-cyan-400/30 rounded-xl p-3 text-sm text-white outline-none focus:border-cyan-400"
                      >
              ...
              <div className="glass-card rounded-2xl p-5 sticky top-4 space-y-4">
                ...
                <div className="space-y-3 pt-4 border-t border-cyan-400/20">
                  <button
                    ...
                    className="w-full py-4 bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-400 disabled:from-gray-800 disabled:to-gray-800 text-black rounded-xl font-black uppercase text-sm flex items-center justify-center gap-2 transition-all"
                  >
                    {isGenerating ? (
                      <>
                  ...
                  <button
                    ...
                    className="w-full py-3 glass-card border border-blue-400/30 text-blue-300 rounded-xl font-bold text-xs flex items-center justify-center gap-2 transition-all"
                  >
                    <Eye size={16} />
            ...
            <div className="glass-card rounded-2xl p-6 max-w-3xl w-full my-8">
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  ...
                  className="p-2 bg-red-500/20 border border-red-400/40 text-red-400 rounded-xl"
                >
                  <X size={20} />
                </button>
              </div>
              ...
              <div className="bg-white rounded-xl p-4 mb-6 relative" style={{ touchAction: 'none' }}>
                <canvas
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-3 bg-gradient-to-r from-emerald-500 to-teal-500 text-black rounded-xl font-bold hover:from-emerald-400 hover:to-teal-400 transition-all flex items-center justify-center gap-2"
                >
                  <Save size={16} />
                  Enregistrer
                </button>
