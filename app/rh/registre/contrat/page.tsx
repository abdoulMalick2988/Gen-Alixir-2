...
// ⚠️ Collez ce code IMMÉDIATEMENT après la fin de la Partie 2
  ...
  return (
    <div
      className="min-h-screen eco-scroll"
      style={{
    ...
    >
        ...
        {Array.from({ length: 6 }).map((_, i) => (
          <div
            ...
            style={{
              ...
              animation: `floatParticle ${8 + Math.random() * 12}s linear ${Math.random() * 5}s infinite`,
            }}
          />
        ))}
      </div>
      ...
      {/* MAIN CONTENT                           */}
      {/* ═══════════════════════════════════════ */}
      <div className="relative max-w-6xl mx-auto px-4 py-6 md:px-8 md:py-8" style={{ zIndex: 10 }}>
